<template>
  <div class="mt-4 songs">
    <panel title="Edit song" subtitle="Add songs to database">
      <div slot="panel">
        <div class="px-8 py-8">
          <v-form
            ref="form"
...
import SongsService from '@/services/SongsService'
  ...
  export default {
    ...
    methods: {
      ...
      async validate () {
        console.log("publish before validated: ", this.valid)
        this.$refs.form.validate()
        console.log("publish after validated: ", this.valid)
        if (this.valid) {
          const res = await SongsService.put(this.song)
          this.$router.push({
            name: 'song',
            params: {
              songId: this.songId
